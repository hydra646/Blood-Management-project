    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='donation_approvals', to=settings.AUTH_USER_MODEL)),
                ('blood_bank', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='donations', to='core.bloodbank')),
